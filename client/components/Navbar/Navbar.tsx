...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    (isDark) ? setEnabled(true) : setEnabled(false);
        ...
        <>
          <div className="max-w-9xl px-2  sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="ml-auto absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <button
                  type="button"
