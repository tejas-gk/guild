...
export default function MenuItems({icon,postId}) {
    ...
    <div>
      <Menu as="div" className="relative inline-block text-left">
        <div>
          ...
          bg-opacity-20  text-sm font-medium text-black dark:text-white
          hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white 
          focus-visible:ring-opacity-75 dark:hover:text-black">
            {icon}        
          </Menu.Button>
        </div>
        <Transition
